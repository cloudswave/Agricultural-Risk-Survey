    ...
    l.prototype = {
        buildListview: function(b, c) {
            ...
            for (var h in b) {
                ...
                (e.option.hasCheckbox || e.option.hasRadiobox) && j.find("input").on("change",
                function(a) {
                    //a.currentTarget.parentElement.parentElement.lv_data
                    d=a.currentTarget.parentElement.parentElement.lv_data;
                    d.checked = a.currentTarget.checked,
                    e.option.hasCheckbox && e.emit("checkbox:change", e, j, d),
                    e.option.hasRadiobox && e.emit("radio:change", e, j, d)
                }),
                d.append(j)
            }
            var l = a(".switch", d);
